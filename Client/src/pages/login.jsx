...
<div className="p-8 w-96 h-auto absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center border-solid border-4 border-marigold-200 flex flex-col gap-8 "> 
    <h1 className="text-marigold-200 text-2xl font-bold">Login</h1>
    ...
    <div className="flex flex-col gap-6">
      ...
      <p className="text-marigold-200 font-bold text-sm"> Don{"'"}t have an Account? Click <Link to={"/SignUp"} className="underline text-white">Here</Link></p>
      ...
      <button className=" rounded-2xl text-white bg-marigold-200 font-bold p-2 w-32">
        <Link className="flex flex-row flex-wrap justify-center items-center gap-2"> <IoLogIn   className="w-5 h-5"/>Login</Link>
      </button>
